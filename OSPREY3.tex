...
\title{{\sc osprey} 3.0: Open-Source Protein Redesign for You, Refactored, with Powerful New Features}
...
\\
We present the third major release of the OSPREY protein design software, along with comparisons to experimental data that confirm its ability to predict protein mutants with improved function.  \osprey 3.0 has significant efficiency, ease-of-use, and algorithmic improvements over previous versions, including GPU acceleration and a new Python interface.  
\end{minipage}
}}
\end{figure}
