...
\begin{table}
\caption{
Details of 45 protein design test cases run on both \osprey 2.2 and \osprey 3.0.  Test cases primarily adapted from Ref.~\citen{EPIC}.  $^a$ Y indicates a partition function calculation (a subroutine of the $K^*$ algorithm~\cite{K*,minDEE}), which analyzes a thermodynamic ensemble of conformations; N indicates calculation of the single global minimum-energy conformation (GMEC). }
\resizebox{\textwidth}{!}{
